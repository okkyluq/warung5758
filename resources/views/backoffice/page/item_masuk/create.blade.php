...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Data Master - Tambah Data Satuan @endsection
@section('style')
		...
		<div class="col-sm-6">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Data Satuan</span></h5>
				</div>
