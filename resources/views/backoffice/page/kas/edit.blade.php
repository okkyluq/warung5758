		...
		<div class="col-sm-6">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Data Kas</span></h5>
				</div>

				<div class="panel-body">
					<form action="{{ url(Request::segment(1).'/'.Request::segment(2).'/'.$kas->id) }}" method="POST" id="form-akun">
                        @method('PUT')
                        <div class="row form-group">
                            <div class="col-md-5 {{ $errors->has('kode_kas') ? "has-error" : "" }}">
                                <label class="text-bold"> *Kode Kas : </label>
                                <input type="text" class="form-control disabled" id="kode_kas" name="kode_kas" placeholder="Masukan Kode Kas" value="{{ $kas->kode_kas }}" readonly>
                        ...
                        <div class="row form-group">
                            <div class="col-md-10 {{ $errors->has('nama_kas') ? "has-error" : "" }}">
                                ...
                                <input type="text" class="form-control" id="nama_kas" name="nama_kas" placeholder="Masukan Nama Kas" value="{{ $kas->nama_kas }}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-10 {{ $errors->has('type_kas') ? "has-error" : "" }}">
                                ...
                                <select id="type_kas" class="form-control" name="type_kas" disabled>
                                    <option value="">Pilih Tipe Kas</option>
                                    <option value="1" {{ $kas->type_kas == '1' ? "selected" : "" }}>Tunai</option>
                                    <option value="2" {{ $kas->type_kas == '2' ? "selected" : "" }}>Bank</option>
                                </select>
                        ...
                        <div class="row form-group">
                            <div class="col-md-10 {{ $errors->has('akun_id') ? "has-error" : "" }}">
                                ...
                                <select id="akun_id" class="form-control" name="akun_id" disabled></select>
...
$(document).ready(function(){
    ...
    }).append(kas.akun ? new Option(kas.akun.nama_akun, kas.akun.id, true, true) : null).trigger('change');
});
