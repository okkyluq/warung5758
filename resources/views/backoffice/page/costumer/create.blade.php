		...
		<div class="col-sm-6">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Data Costumer</span></h5>
				</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-12 form-group {{ $errors->has('satuan') ? "has-error" : "" }}">
									...
									<input type="text" class="form-control " placeholder="Nama Costumer" name="nama_costumer">
