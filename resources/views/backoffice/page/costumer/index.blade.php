...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Data Master - Data Costumer @endsection
@section('style')
@endsection
@section('content')
<div class="content">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Daftar Costumer</span></h5>
				</div>
				<div class="panel-body">
					<div class="pull-right">
						<a href="{{ url(Request::url().'/create') }}" class="btn bg-green-600 btn-labeled text-bold"><b><i class="icon-plus-circle2"></i></b> Tambah Data Costumer</a>
					</div>
				</div>
				...
				<table class="table datatable-basic table-xxs table-bordered table-framed">
					<thead class="bg-slate-800 text-semibold">
						<tr>
							...
							<th class="text-left">Nama Costumer</th>
...
<script>
	...
	var oTable = $('.datatable-basic').DataTable({
		...
		language: {
    		searchPlaceholder: 'Cari Berdasarkan Nama Costumer',
		},
		columnDefs :[
		...
		columns: [
			...
			{data : 'nama_costumer', name : 'nama_costumer', orderable: false, class: 'text-left'},
