		...
		<div class="col-sm-12">
			<div class="panel panel-flat border-top-xlg border-top-slate-800">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Data Produksi Bill Of Material</span></h5>
				</div>

				<div class="panel-body">
					<div class="pull-right">
						<a href="{{ url(Request::url().'/create') }}" class="btn bg-primary-800 btn-labeled text-bold"><b><i class="icon-plus-circle2"></i></b> Produksi Bill Of Material</a>	
					</div>
				</div>
...
<script>
    var oTable = $('.datatable-basic').DataTable({
		...
		columns: [
			{data : 'no_produksi', name : 'no_produksi', orderable: false, searchable: true, class: 'text-center'},
			{data : 'tgl_produksi', name : 'tgl_produksi', orderable: false, searchable: true, class: 'text-center'},
			{data : 'item', name : 'item', orderable: false, searchable: true, class: 'text-center'},
			{data : 'qty', name : 'qty', orderable: false, searchable: true, class: 'text-center'},
