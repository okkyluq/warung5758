...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Sistem - Daftar Nilai Awal Item @endsection
@section('style')
@endsection
@section('content')
<div class="content">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Daftar Nilai Awal Item</span></h5>
				</div>
