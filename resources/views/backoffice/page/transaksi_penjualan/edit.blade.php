...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Transaksi penjualan - Edit Transaksi Penjualan @endsection
@section('style')
...
<div class="page-header page-header-default">
	...
	<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
		<ul class="breadcrumb">
			...
			<li class="active">Edit Transaksi Penjualan</li>
		</ul>
	</div>
</div>
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				...
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Transaksi penjualan</span></h5>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">No. Penjualan :</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="No. penjualan" readonly name="no_penjualan" value="{{ $transaksi->no_penjualan }}">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Costumer :</label>
                            <div class="col-lg-6">
...
jQuery.TransaksiPenjualanEdit = function(transaksi) {
    var data = transaksi;
    // console.log(data);

    var $newOptionCostumer = $("<option selected='selected'></option>").val(data.costumer.id).text(data.costumer.nama_costumer);
    $("#costumer").focus().append($newOptionCostumer).trigger('change');
    ...
    $('input[name="tgl_penjualan"]').daterangepicker({ 
        ...
        startDate: moment(data.tgl_penjualan).format('MM/DD/YYYY'),
    });
    ...
    data.det_transaksi_penjualan.forEach(isi => {
        console.log(isi);
        var html = `<tr>
...
$(document).ready(function() {
    ...
    $.TransaksiPenjualanEdit(transaksi);
    ...
    $("#pencarian-item").autocomplete({
        serviceUrl: "{{ url('getitem?opsi_jual=1')}}",  
        dataType: "JSON",
        onSelect: function (suggestion) {
            ...
            .find('td:eq(2)').end()
            .find('a#satuan').editable({
                value: suggestion.item.get_satuan_penjualan.id,
                source: satuan
            }).end()
            .find('#harga').editable({
                display: function(value, sourceData){
