...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Sistem - Buat Penyesuaian Stock @endsection
@section('style')
...
<div class="page-header page-header-default">
	...
	<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
		<ul class="breadcrumb">
			...
			<li class="active">Buat Penyesuaian Stock</li>
		</ul>
	</div>
</div>
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				...
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Penyesuaian Stock</span></h5>
				</div>
                    ...
                    <table class="table table-sm" id="table-transaksi">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="200">
                                    <input name="qty" id="qty" class="form-control text-right" placeholder="Qty" disabled>
                                </td>
                                <td width="200">
...
$(document).ready(function() {
    ...
    $('#form-transaksi').on('submit', function() {
    	...
    	tr.each(function(){
	        ...
	        item ["qty"]                    = parseInt($(this).find('#qty').val());
	        jsonObj.push(item);
    	});
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.status == "sukses"){
                    window.location.href = "{{ url('sistem/penyesuaian-stock') }}";
                }
            },
