...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Data Master - Edit Data Barang @endsection
@section('style')
		...
		<div class="col-sm-12">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Data Produk</span></h5>
				</div>
				
				<div class="panel-body" id="app">
					<edit-barang :edit="{{ $produk }}"></edit-barang>
				</div>
			</div>
		</div>
	</div>
