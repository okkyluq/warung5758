...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Keuangan - Lihat Hutang @endsection
@section('style')
@endsection
@section('content')
<div class="content">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Lihat Daftar Hutang</span></h5>
				</div>
...
<script>
	...
	var oTable = $('.datatable-basic').DataTable({
		...
		columns: [
			...
			{data : 'nama_supplier', name : 'nama_supplier', orderable: false, class: 'text-left text-bold'},
