		...
		<div class="col-sm-4">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Data User</span></h5>
				</div>

				<div class="panel-body">
					<form action="{{ url(Request::segment(1).'/'.Request::segment(2).'/'.$user->id) }}" method="POST" id="form-satuan">
                        @method('PUT')
						<div class="form-group">
							<div class="row">
								<div class="col-md-12 form-group {{ $errors->has('name') ? "has-error" : "" }}">
									<label class="text-bold">Nama Lengkap :</label>
									<input type="text" class="form-control " placeholder="Masukan Nama Lengkap" name="name" value="{{ old('name', $user->name) }}">
									@if ($errors->has('name'))
                                ...
                                <div class="col-md-12 form-group {{ $errors->has('username') ? "has-error" : "" }}">
									...
									<input type="text" class="form-control " placeholder="Masukan Username" name="username" value="{{ old('username', $user->username) }}">
