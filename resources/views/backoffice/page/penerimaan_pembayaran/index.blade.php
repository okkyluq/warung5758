...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Keuangan - Daftar Penerimaan Pembayaran @endsection
@section('style')
@endsection
@section('content')
<div class="content">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Lihat Daftar Penerimaan Pembayaran</span></h5>
				</div>

                <div class="panel-body">
					<div class="pull-right">
						<a href="{{ url(Request::url().'/create') }}" class="btn bg-primary-800 btn-labeled text-bold"><b><i class="icon-plus-circle2"></i></b> Buat Penerimaan Pembayaran</a>	
					</div>
				</div>
...
<script>
	...
	var oTable = $('.datatable-basic').DataTable({
		...
		columns: [
			...
			{data : 'kode_penerimaan_pembayaran', name : 'kode_penerimaan_pembayaran', orderable: false, class: 'text-center text-bold'},
			{data : 'tgl_penerimaan_pembayaran', name : 'tgl_penerimaan_pembayaran', orderable: false, class: 'text-center text-bold'},
			{data : 'costumer', name : 'costumer', orderable: false, class: 'text-center text-bold'},
			{data : 'total_penerimaan_pembayaran', name : 'total_penerimaan_pembayaran', orderable: false, class: 'text-right text-bold'},
