...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<a href="{{ url('sistem/set-nilai-item') }}"><h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Data Penerimaan Pembayaran</span></h4></a>
	...
	<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
		<ul class="breadcrumb">
			...
			<li class="active">Buat Penerimaan Pembayaran</li>
		</ul>
	</div>
</div>
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				...
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Penerimaan Pembayaran Baru</span></h5>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="No. Pembayaran" readonly name="kode_penerimaan_pembayaran" value="{{ $kode }}">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Tanggal :</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="Tanggal" name="tgl_penerimaan" id="tgl_penerimaan">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-lg-12">
                            <button type="button" id="btn-pilih-piutang" class="btn bg-success btn-labeled"><b><i class="icon-folder-search"></i></b> Pilih Piutang</button>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered" id="table-transaksi">
                        ...
                        <tbody>
                            <tr id="empty-rows">
                                <td colspan="6" class="text-bold text-center">Data Penerimaan Pembayaran Belum Ada</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                                    ...
                                    <div class="table-responsive no-border">
                                        <table class="table table-xxs table-framed">
                                            <tbody>
                                                <tr>
                                                    <th>Total Piutang :</th>
                                                    <td class="text-right"><input type="text" name="total_piutang" id="total_piutang" class="form-control input-xs text-right text-bold" readonly value="0"></td>
                                                </tr>
                                                <tr>
...
@include('backoffice.page.penerimaan_pembayaran.partials.modal')
@endsection
@section('script')
...
@include('backoffice.page.penerimaan_pembayaran.partials.script')
@endsection