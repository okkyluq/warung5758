		...
		<div class="col-sm-6">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Data Supplier</span></h5>
				</div>

				<div class="panel-body">
					<form action="{{ url(Request::segment(1).'/'.Request::segment(2).'/'.$supplier->id) }}" method="POST" id="form-satuan">
						<div class="form-group">
							<div class="row">
								<div class="col-md-12 form-group {{ $errors->has('satuan') ? "has-error" : "" }}">
									<label class="text-bold">Nama Supplier :</label>
									<input type="text" class="form-control " placeholder="Nama Supplier" name="nama_supplier" value="{{ $supplier->nama_supplier }}">
								...
								<div class="col-md-12 form-group {{ $errors->has('keterangan') ? "has-error" : "" }}">
									...
									<textarea name="keterangan" id="keterangan" cols="30" rows="3" class="form-control" placeholder="Masukan Keterangan Jika Ada">{{ $supplier->keterangan }}</textarea>
