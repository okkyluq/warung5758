...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Data Master - Daftar Akun @endsection
@section('style')
@endsection
@section('content')
<div class="content">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Daftar Akun</span></h5>
				</div>
				<div class="panel-body">
					<div class="pull-right">
						<a href="{{ url(Request::url().'/create') }}" class="btn bg-green-600 btn-labeled text-bold"><b><i class="icon-plus-circle2"></i></b> Buat Akun Baru</a>	
					</div>
				</div>
				...
				<table class="table datatable-basic table-xxs table-bordered table-framed">
					<thead class="bg-slate-800 text-semibold">
						<tr>
							...
							<th class="text-center" width="150">Kategori Akun</th>
							<th class="text-center">Nama Akun</th>
							<th class="text-center" width="150">Status Induk</th>
							<th class="text-center" width="150">Status Pembayaran</th>
...
<script>
	...
	var oTable = $('.datatable-basic').DataTable({
		...
		columns: [
			...
			{data : 'kategori_akun_id', name : 'kategori_akun_id', orderable: true, class: 'text-left'},
			{data : 'nama_akun', name : 'nama_akun', orderable: false, class: 'text-left'},
			{data : 'status_header', name : 'status_header', orderable: true, class: 'text-center'},
			{data : 'status_pembayaran', name : 'status_pembayaran', orderable: true, class: 'text-center'},
