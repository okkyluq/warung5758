		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				...
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Bill Of Material</span></h5>
				</div>
				...
				<div class="panel-body">
					...
					<div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="No. B.O.M" readonly name="no_bom" value="{{ $no_bom }}">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <label class="col-lg-2 control-label text-right">Qty :</label>
                            <div class="col-lg-2">
				...
				<div class="panel-footer"><a class="heading-elements-toggle" style="margin-top: 200px;"><i class="icon-more"></i></a>
					<div class="heading-elements">
						<div class="pull-right">
							...
							<button type="submit" class="btn btn-success"><b><i class="icon-floppy-disk"></i></b> Simpan B.O.M</button>
						</div>
					</div>
					</form>
				</div>
