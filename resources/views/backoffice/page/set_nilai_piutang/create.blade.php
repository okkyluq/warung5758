...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Set Akun Awal - Buat Set Nilai Piutang @endsection
@section('style')
...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<a href="{{ url('sistem/set-nilai-akun') }}"><h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Data Nilai Awal Piutang</span></h4></a>
	...
	<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
		<ul class="breadcrumb">
			...
			<li class="active">Buat Set Nilai Awal Piutang</li>
		</ul>
	</div>
</div>
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				...
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Set Nilai Awal Piutang</span></h5>
				</div>
...
<script>
var akun_piutang = {!! $akun_piutang !!};
var option_piutang = new Option(akun_piutang.kode+' - '+akun_piutang.value , akun_piutang.id, false, false);
...
}).append(option_piutang).trigger('change');
