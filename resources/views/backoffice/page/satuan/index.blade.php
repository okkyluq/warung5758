		...
		<div class="col-sm-12">
			...
			<div class="panel panel-flat border-top-xlg border-top-green-600">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Daftar Satuan</span></h5>
				</div>
...
<script>
	...
	var oTable = $('.datatable-basic').DataTable({
		...
		language: {
    		searchPlaceholder: 'Cari Berdasarkan Satuan',
		},
		columnDefs :[
		...
		columns: [
			...
			{data : 'satuan', name : 'satuan', orderable: false, class: 'text-left'},
