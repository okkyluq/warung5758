...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Manajemen Toko - Edit Data Satuan @endsection
@section('style')
...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h2><i class="icon-pencil7 position-left"></i> <span class="text-semibold">Kelola Data Satuan</span></h2>
		</div>
	</div>
		...
		<div class="col-sm-6">
			<div class="panel panel-flat border-top-xlg border-top-primary" id="panel-buat-barang">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Edit Data Satuan</span></h5>
				</div>

				<div class="panel-body">
					<form action="{{ url(Request::segment(1).'/'.Request::segment(2).'/'.$satuan->id) }}" method="POST" id="form-satuan">
						<div class="form-group">
							<div class="row">
								<div class="col-md-12 form-group {{ $errors->has('satuan') ? "has-error" : "" }}">
									<label class="text-bold">Satuan Barang :</label>
									<input type="text" class="form-control " placeholder="Satuan" name="satuan" value="{{$satuan->satuan}}">
								...
								<div class="col-md-12 form-group {{ $errors->has('keterangan') ? "has-error" : "" }}">
									...
									<textarea name="keterangan" id="keterangan" cols="30" rows="3" class="form-control" placeholder="Masukan Keterangan Jika Ada">{{ $satuan->keterangan }}</textarea>
