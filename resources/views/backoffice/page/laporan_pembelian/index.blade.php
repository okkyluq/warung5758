		...
		<div class="col-sm-12">
			<div class="panel panel-flat border-top-xlg border-top-slate-800" id="panel-laporan">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Laporan Pembelian</span></h5>
				</div>
				<div class="panel-body">
                    <form action="{{ url(Request::url()) }}" class="form-horizontal" method="POST" id="form-transaksi">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label text-right text-bold">Supplier :</label>
                            <div class="col-lg-2">
