...
@section('title'){{ env("SET_TOKO", "NOT SET") }} | Sistem - Buat Retur Pembelian @endsection
@section('style')
...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<a href="{{ url('sistem/set-nilai-item') }}"><h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Data Retur Pembelian</span></h4></a>
	...
	<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
		<ul class="breadcrumb">
			...
			<li class="active">Buat Retur Pembelian</li>
		</ul>
	</div>
</div>
		...
		<div class="col-sm-12">
			<div class="panel panel-flat border-top-xlg border-top-green-600" id="panel-buat-item">
				<div class="panel-heading">
					<h5 class="panel-title"><span class="text-semibold"><i class="icon-file-plus"></i> Buat Retur Pembelian</span></h5>
                    <div class="heading-elements">
                        <button id="btn-modal-import-pembelian" type="button" class="btn border-slate text-slate-800 btn-flat"><i class=" icon-import position-left"></i> Import Pembelian</button>
                    </div>
				</div>
				...
				<div class="panel-footer"><a class="heading-elements-toggle" style="margin-top: 200px;"><i class="icon-more"></i></a>
					<div class="heading-elements">
						<div class="pull-right">
							<a href="{{ url('sistem/retur/retur-pembelian') }}" class="btn btn-default"><b><i class="icon-circle-left2"></i></b> Kembali</a>
...
<div id="modal_import_pembelian" class="modal fade" tabindex="-99" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h5 class="modal-title">Cari Pembelian</h5>
            </div>
            ...
            <div class="modal-body">
                ...
                <table class="table table-sm table-bordered" id="table-pencarian-pembelian">
                    <thead>
                        <tr class="bg-success">
                            <th class="text-center" width="120">No.Pembelian</th>
...
@include('backoffice.page.retur_pembelian.partials.script_create')
<script>
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.status == "sukses"){
                    window.location.href = "{{ url('sistem/retur/retur-pembelian') }}";
                }
            },
