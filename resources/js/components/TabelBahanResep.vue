<template>
    <div>
        ...
        <table class="table table-framed table-xs" id="tabel-bahan-resep" v-if="form.jenis_produk === 'komposit'">
            ...
            <tbody>
                <template v-if="!form.list_bahan.length">
                <tr>
    ...
    export default {
        ...
        methods: {
            ...
            sendData(){
                ...
                //     kategori_produk : this.form.kategori ? this.form.kategori.id : null,
                //     satuan_produk : this.form.satuan ? this.form.satuan.id : null,
                //     opsi_produk: this.form.opsi_produk,
                //     jenis_produk: this.form.jenis_produk,
                //     gambar: this.form.gambar,
                //     list_bahan: this.form.list_bahan
                // });
                ...
                axios.post(window.location.origin + '/data-master/produk/', data, config)
                .then(response => {
