    ...
    <div>
        <div class="panel panel-flat border-top-xlg border-top-green-600">
            <div class="panel-heading">
                <h5 class="panel-title"><span class="text-semibold"><i class="icon-table2"></i> Daftar Item Masuk</span></h5>
            </div>
            <div class="panel-body">
                <div class="pull-left">
                    <div class="col-sm-4">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" placeholder="ID Item Masuk" v-model="id_item_masuk" v-on:keyup="getDataItemMasuk">
                            <div class="form-control-feedback">
                                <i class="icon-search4 text-size-base"></i>
                            </div>
                        </div>
                    </div>
                    <date-picker v-model="range_date" @change="getDataItemMasuk" :clearable="false" type="date" value-type="format" format="DD-MM-YYYY" range placeholder="Select date range"></date-picker>
                </div>
                <div class="pull-right">
                    <a v-on:click.prevent="showPanel" href="" class="btn bg-green-600 btn-labeled text-bold"><b><i class="icon-plus-circle2"></i></b> Buat Item Masuk</a>	
                </div>
            </div>
...
<script>
    ...
    import createitemmasuk from './Create';
    import axios from 'axios';
    import Swal from 'sweetalert2'
    import 'sweetalert2/src/sweetalert2.scss'

    export default {
        components: { DatePicker, createitemmasuk},
        data(){
            return {
