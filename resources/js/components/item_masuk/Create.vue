        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success" style="border-bottom: none;">
                <div class="panel-heading" style="border-top-right-radius: 0; border-top-left-radius:0;">
                    <h6 class="panel-title">Item Masuk<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
...
<script>
    ...
    export default {
        ...
        methods: {
            getItemMasukID: function(){
                axios.get(window.location.origin + '/getitemmasukid')
                .then(response => {
            ...
            submitForm(){
                axios.post(window.location.origin + '/kelola-stock/item-masuk', this.form)
                .then(response => {
