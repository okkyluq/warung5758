        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success" style="border-bottom: none;">
                <div class="panel-heading" style="border-top-right-radius: 0; border-top-left-radius:0;">
                    <h6 class="panel-title">Transaksi Produk Keluar<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                ...
                <div class="panel-body">
                    <form action="" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <date-picker type="date" value-type="format" format="DD-MM-YYYY" placeholder="Pilih Tanggl Produk Keluar" v-model="form.tgl_keluar"></date-picker>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    export default {
        ...
        mounted(){
            this.getProdukKeluarID()
        },
        methods: {
            getProdukKeluarID: function(){
                axios.get(window.location.origin + '/getprodukkeluarid')
                .then(response => {
            ...
            submitForm(){
                axios.post(window.location.origin + '/transaksi/produk-keluar', this.form)
                .then(response => {
