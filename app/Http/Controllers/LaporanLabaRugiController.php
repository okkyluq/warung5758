...
class LaporanLabaRugiController extends Controller
{
    public function index(Request $request)
    {
        if ($request->isMethod('POST')) {
            ...
            ->whereIn('no_kategori', [4, 5])
            ->get();

            return view('backoffice.page.laporan_laba_rugi.partials.ajax_laporan_laba_rugi', [
                'akun' => $akun,
                'tgl_awal' => $tgl[0],
                'tgl_akhir' => $tgl[1]
            ])->render();
        ...
        return view('backoffice.page.laporan_laba_rugi.index');
    }
}
