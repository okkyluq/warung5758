...
class CreateTableDetReturPembelian extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('det_retur_pembelian', function (Blueprint $table) {
            ...
            $table->foreign('retur_pembelian_id')->on('retur_pembelian')->references('id')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('det_retur_pembelian');
    }
}
